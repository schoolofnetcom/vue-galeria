      ...
      <div class="wrapper tab-item">
        <div class="custom-row">
          <div class="wrapper " align="center">
            <h1 class="ti title">{{ title }}</h1>
          </div>
          <div class="column-12 column-xs-12 column-sm-12 tab">
            <div class="custom-row">
              <div class="column-md-6 column-xs-12 hide-sm hide-md box-tab" :class="image.css || 'column-4'" v-for="(image, i) of images" :key="i">
...
@import url('https://fonts.googleapis.com/css?family=Poppins:400,600,800,300');
...
body {
	...
	background-image: url(http://www.scalsys.com/backgrounds/light-gray-background-texture/light-gray-background-texture_699054.jpg);
